...
import  { UserBusinessMock } from "../src/business/UserBusinessMock"
...
describe("getUserById", () => {
  test("Should catch erros code and message when an user are not registered", async () => {
    expect.assertions(2)
    try {
    const result =  await userBusinessMock.getUserById('gilsunFF')
    console.log('TETETETET: ',result)
    } catch (error) {
